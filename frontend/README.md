...
**AIChat** — чат с помощником: текст, голос, изображения. Streaming ответы через SSE. Приветственный экран с логотипом и задержкой 5 секунд перед приветствием панды.
...
**Games** — PandaPalGo: Крестики-нолики, Шашки, 2048, Эрудит с умным противником. Система достижений и статистики.
...
**Streaming ответов** — ответы приходят через Server-Sent Events (SSE) для быстрой генерации текста.
