  ...
  return (
    <section className="py-16 md:py-28 text-center min-h-[85vh] flex flex-col justify-center">
      ...
      <div className="mt-10 flex flex-col md:flex-row gap-4 justify-center">
        ...
        <a
          href="/play"
          className="px-10 py-5 rounded-full bg-gradient-to-r from-green-400 via-blue-500 to-purple-500 text-white font-semibold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 active:scale-100"
        >
          🎮 PandaPal Go
        </a>
        <a
