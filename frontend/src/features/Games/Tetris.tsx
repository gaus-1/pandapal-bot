...
export function Tetris({ sessionId, onBack, onGameEnd }: TetrisProps) {
  ...
  return (
    <div className="w-full h-full flex flex-col overflow-hidden bg-white dark:bg-slate-900">
      ...
      <div className="flex-1 flex items-center justify-center px-2 sm:px-3 py-2 min-h-0 mb-2">
        <div className="flex items-center justify-center w-full h-full" style={{ maxWidth: '330px' }}>
          <div className="bg-slate-100 dark:bg-slate-900 border-2 border-slate-300 dark:border-slate-700 rounded-lg p-1 shadow-inner w-full" style={{ aspectRatio: '0.5', maxHeight: '100%' }}>
