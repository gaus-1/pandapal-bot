            ...
            <div className="mt-7 sm:mt-8 flex flex-wrap gap-3 justify-center">
              ...
              {directLinkUrl && directLinkLabel && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center px-6 py-3 rounded-full border-2 border-blue-500 dark:border-cyan-500 text-blue-600 dark:text-cyan-400 font-semibold hover:bg-blue-50 dark:hover:bg-slate-700/50 transition-colors"
                >
                  {directLinkLabel}
                </a>
              )}
