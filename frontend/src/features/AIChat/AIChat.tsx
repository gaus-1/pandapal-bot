      ...
      <div className="flex-shrink-0 bg-gradient-to-r from-blue-500 to-cyan-500 dark:from-slate-800 dark:to-slate-800 shadow-sm p-1 sm:p-1.5 border-b border-blue-500/30 dark:border-slate-700 relative z-10">
        <div className="flex items-center gap-1 sm:gap-1.5">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-[11px] sm:text-xs md:text-sm font-display font-bold text-white dark:text-slate-100 drop-shadow-sm truncate">
              PandaPal AI
            </h1>
            <p className="text-[9px] sm:text-[11px] md:text-xs text-blue-50 dark:text-slate-300 font-semibold truncate">
