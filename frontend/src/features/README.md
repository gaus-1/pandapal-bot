...
### AIChat
Чат с помощником. Поддержка текста, голоса, изображений. Streaming ответы через SSE.

### Games
Игры PandaPalGo:
- TicTacToe — крестики-нолики с умным противником
- Checkers — шашки с умным противником
- Game2048 — игра 2048
- Erudite — составление слов
