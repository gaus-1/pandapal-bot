...
export function DonationScreen({ user }: DonationScreenProps) {
  ...
  return (
    <div className="w-full h-full bg-gradient-to-br from-amber-50/40 via-orange-50/40 to-yellow-50/40 dark:from-slate-900 dark:via-slate-850 dark:to-slate-800 overflow-y-auto backdrop-blur-sm">
