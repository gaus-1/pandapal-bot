...
export const FEATURES: readonly Feature[] = [
  ...
  },
  {
    id: 'pandapalgo',
    title: 'PandaPalGo',
    description: 'Играй с пандой в крестики-нолики, виселицу и 2048!',
  },
] as const;
...
export const SECTIONS: readonly Section[] = [
  ...
  },
  {
    ...
    description:
      'Открой для себя увлекательные игры с пандой! Крестики-нолики, виселица, 2048 и другие игры ждут тебя. Играй, побеждай и зарабатывай достижения! Каждая победа приближает тебя к новым наградам. Игры адаптированы для детей и помогают развивать логику и мышление.',
  },
] as const;
