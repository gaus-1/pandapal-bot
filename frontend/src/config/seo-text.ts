...
export const PANDA_PET_FAQ_RU: { question: string; answer: string }[] = [
  ...
  },
  {
    ...
    answer:
      'В Mini App откройте раздел «Моя панда», нажимайте кнопки «Покормить», «Играть», «Уложить спать». Лимиты по времени защищают от перекорма; панда показывает разные эмоции в зависимости от состояния.',
  },
  {
