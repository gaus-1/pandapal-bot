...
class TestCompleteUserJourney:
    ...
    async def test_complete_user_journey_from_website_to_achievements(
        ...
        with patch("bot.api.miniapp_endpoints.TelegramWebAppAuth") as mock_auth_class:
            mock_auth = MagicMock()
        ...
        ai_patch2 = None
        if not has_yandex_keys:
            vision_patch = patch("bot.api.miniapp_endpoints.VisionService")
            ...
            ai_patch2 = patch("bot.api.miniapp_endpoints.get_ai_service")
        ...
        ai_patch3 = None
        if not has_yandex_keys:
            speech_patch = patch("bot.api.miniapp_endpoints.SpeechService")
            ...
            ai_patch3 = patch("bot.api.miniapp_endpoints.get_ai_service")
