...
│   │   │   │   └── tables_and_diagrams.py # Предметные таблицы
...
│   │   ├── news/                        # Новостной сервис
│   │   │   ├── sources/                 # Источники новостей
│   │   │   ├── adapters/                # Адаптеры контента
│   │   │   └── moderators/              # Модерация новостей
...
**Статистика тестов:**
- 🧪 **Всего тестов: 1000+**
- ✅ **Unit тесты: 60+ файлов** (безопасность, SSRF, audit logging, БД, кеш, модерация, игры, новости, сервисы)
