...
✅ **Безопасность превыше всего** — 150+ фильтров контента, модерация 24/7, мягкое перенаправление с запрещенных тем
✅ **Telegram Mini App** — полнофункциональное веб-приложение внутри Telegram (работает на ПК и мобильных)
✅ **Адаптивность** — контент подстраивается под возраст ребенка (1-9 класс)
✅ **Мультимодальность** — текст, голос, изображения с реальной обработкой через Yandex Cloud
✅ **Современный стек** — Python 3.13, React 18, PostgreSQL 17, TanStack Query, Zustand, FFmpeg
✅ **Российский AI** — полная интеграция с Yandex Cloud (YandexGPT Lite, SpeechKit STT, Vision OCR)
✅ **Качественный код** — соответствие PEP 20, модульная архитектура, 447+ тестов, идиоматичный Python
✅ **Упрощенные формулы** — химические уравнения и математические формулы представлены простыми словами и таблицами для детей
