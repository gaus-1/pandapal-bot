...
### 🎨 **Мультимодальность**
- ✅ **Текст** — полноценный AI чат с YandexGPT Lite
- ✅ **Голос** — распознавание речи через Yandex SpeechKit STT
- ✅ **Изображения** — анализ фото через Yandex Vision OCR
- ✅ **Решение задач с фото** — математика, физика, химия по фотографии
- ✅ **Реальная обработка медиа** — не имитация, полная интеграция с Yandex Cloud
...
### 🇷🇺 **Российский AI**
- ✅ **YandexGPT Lite** — генерация ответов на русском языке
- ✅ **SpeechKit STT** — распознавание русской речи
- ✅ **Vision OCR** — распознавание текста на изображениях
- ✅ **Полная интеграция** — все сервисы через Yandex Cloud API
...
#### **🤖 Telegram Бот**
- ✅ Текстовые запросы с AI ответами (YandexGPT Lite)
- ✅ Голосовые сообщения (Yandex SpeechKit STT)
- ✅ Аудиофайлы (распознавание речи, WebM → OggOpus через FFmpeg)
- ✅ Анализ изображений (Yandex Vision OCR)
...
- ✅ Реальная обработка медиа (Yandex Vision OCR, SpeechKit STT)
...
- ✅ Yandex Metrika интеграция (ID: 104525544, SSR поддержка)
...
- **Yandex Metrika** (ID: 104525544) — веб-аналитика с SSR поддержкой
...
- **Mini App:** Полностью функциональный с реальной обработкой медиа (Yandex Cloud)
- **AI:** YandexGPT Lite, SpeechKit STT, Vision OCR
