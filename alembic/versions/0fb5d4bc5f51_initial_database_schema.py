...
def upgrade() -> None:
    ...
    op.create_table('users',
        ...
        sa.ForeignKeyConstraint(['parent_telegram_id'], ['users.telegram_id'], ),
    ...
    op.create_table('learning_sessions',
        ...
        sa.Column('session_start', sa.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=True),
