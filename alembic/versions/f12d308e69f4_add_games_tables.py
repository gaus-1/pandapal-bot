...
def upgrade() -> None:
    conn = op.get_bind()
    # analytics_alerts, analytics_config, analytics_trends уже созданы в a1b2c3d4e5f6
    if not _table_exists(conn, "analytics_alerts"):
        op.create_table(
            "analytics_alerts",
    ...
    if not _table_exists(conn, "analytics_config"):
        op.create_table(
            "analytics_config",
            sa.Column("id", sa.Integer(), nullable=False),
    ...
    if not _table_exists(conn, "analytics_trends"):
        op.create_table(
            "analytics_trends",
            sa.Column("id", sa.Integer(), nullable=False),
    ...
    _drop_index_if_exists("idx_analytics_metrics_name")
    _drop_index_if_exists("idx_analytics_metrics_timestamp")
    _drop_index_if_exists("idx_analytics_metrics_user")
    _drop_index_if_exists("idx_analytics_metrics_name_time")
    op.create_index(
    ...
    _drop_index_if_exists("idx_analytics_reports_type")
    _drop_index_if_exists("idx_analytics_reports_generated")
    op.create_index(
    ...
    _drop_index_if_exists("idx_chat_history_timestamp")
    _drop_index_if_exists("idx_chat_history_type")
    _drop_index_if_exists("idx_chat_history_user")
    _drop_index_if_exists("idx_chat_history_user_time")
    op.create_index(
    ...
    op.create_index(op.f("ix_chat_history_timestamp"), "chat_history", ["timestamp"], unique=False, if_not_exists=True)
    op.create_index(
        op.f("ix_chat_history_user_telegram_id"), "chat_history", ["user_telegram_id"], unique=False, if_not_exists=True
    )
    op.drop_table_comment(
        "chat_history", existing_comment="История сообщений пользователя с AI", schema=None
    )
    op.execute("ALTER TABLE chat_history DROP COLUMN IF EXISTS metadata")
    op.execute("ALTER TABLE chat_history DROP COLUMN IF EXISTS tokens_used")
    op.alter_column(
        "learning_sessions",
        "id",
        existing_type=sa.BIGINT(),
    ...
    _drop_index_if_exists("idx_learning_sessions_completed")
    _drop_index_if_exists("idx_learning_sessions_start")
    _drop_index_if_exists("idx_learning_sessions_subject")
    _drop_index_if_exists("idx_learning_sessions_user")
    op.create_index(
    ...
    op.execute("ALTER TABLE learning_sessions DROP COLUMN IF EXISTS accuracy")
    op.execute("ALTER TABLE learning_sessions DROP COLUMN IF EXISTS duration_seconds")
    op.execute("ALTER TABLE learning_sessions DROP COLUMN IF EXISTS session_data")
    _drop_index_if_exists("idx_payments_payment_id")
    _drop_index_if_exists("idx_payments_status")
    _drop_index_if_exists("idx_payments_subscription_id")
    _drop_index_if_exists("idx_payments_user_telegram_id")
    op.create_index(op.f("ix_payments_payment_id"), "payments", ["payment_id"], unique=True, if_not_exists=True)
    op.create_index(op.f("ix_payments_status"), "payments", ["status"], unique=False, if_not_exists=True)
    op.create_index(
        op.f("ix_payments_subscription_id"), "payments", ["subscription_id"], unique=False, if_not_exists=True
    )
    op.create_index(
        op.f("ix_payments_user_telegram_id"), "payments", ["user_telegram_id"], unique=False, if_not_exists=True
    )
    op.create_index(
    ...
    _drop_index_if_exists("idx_user_events_timestamp")
    _drop_index_if_exists("idx_user_events_user")
    op.create_index(
        "idx_user_events_user_time", "user_events", ["user_telegram_id", "timestamp"], unique=False, if_not_exists=True
    )
    op.drop_table_comment(
    ...
    _drop_index_if_exists("idx_user_progress_level")
    _drop_index_if_exists("idx_user_progress_points")
    _drop_index_if_exists("idx_user_progress_subject")
    _drop_index_if_exists("idx_user_progress_user")
    op.execute("ALTER TABLE user_progress DROP CONSTRAINT IF EXISTS uq_user_progress_user_subject")
    op.create_index(
        "idx_progress_user_subject", "user_progress", ["user_telegram_id", "subject"], unique=False, if_not_exists=True
    )
    op.create_index(
    ...
    op.execute("ALTER TABLE user_progress DROP COLUMN IF EXISTS average_accuracy")
    op.execute("ALTER TABLE user_progress DROP COLUMN IF EXISTS total_sessions")
    op.execute("ALTER TABLE user_progress DROP COLUMN IF EXISTS total_time_seconds")
    op.alter_column(
        "user_sessions",
        "id",
        existing_type=sa.BIGINT(),
    ...
    _drop_index_if_exists("idx_user_sessions_start")
    _drop_index_if_exists("idx_user_sessions_user")
    _drop_index_if_exists("idx_user_sessions_duration")
    op.create_index(
        "idx_user_sessions_duration", "user_sessions", ["session_duration"], unique=False, if_not_exists=True
    )
    op.create_index(
    ...
    _drop_index_if_exists("idx_users_active")
    _drop_index_if_exists("idx_users_parent_id")
    _drop_index_if_exists("idx_users_telegram_id")
    _drop_index_if_exists("idx_users_type")
