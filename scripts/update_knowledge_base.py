...
async def main():
    ...
    Загружает актуальные образовательные материалы с nsportal.ru
    и school203.spb.ru, группирует по предметам и выводит статистику.

    Raises:
        Exception: При ошибке загрузки или обработки данных.
    """
    logger.info("=" * 60)
