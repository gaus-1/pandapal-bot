...
class AnalyticsService:
    ...
    def get_most_active_subjects(self, telegram_id: int, limit: int = 5) -> list[dict]:
        ...
        subject_keywords = {
            ...
            "иностранный": ["английск", "немецк", "французск", "испанск", "english", "grammar"],
            "история": ["истори", "дата", "событ", "войн", "росси", "всеобщ"],
            "обществознание": ["обществознан", "право", "экономик", "политик"],
            ...
            "информатика": ["информатик", "алгоритм", "программир", "код"],
            "окружающий мир": ["окружающ", "природоведен", "природ"],
            "обж": ["обж", "безопасност", "первая помощь"],
            "физкультура": ["физкультур", "спорт", "зарядк", "тренировк"],
            "технология": ["технологи", "труд", "конструирован", "проект"],
            "изо": ["изобразительн", "рисован", "живопис", "искусств"],
            "музыка": ["музык", "нот", "пение", "композитор"],
