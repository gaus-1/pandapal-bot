...
class QueryExpander:
    ...
    def __init__(self):
        ...
        self.synonyms = {
            ...
            "список": ["таблица значений", "перечень", "все значения"],
            "квадратные корни": ["таблица корней", "значения √n", "извлечение корня"],
        ...
        self.related_terms = {
            ...
            "квадратные корни": ["таблица значений", "√1", "√2", "полные квадраты"],
