...
Набор stateless-функций для:
- дедупликации повторов и артефактов стриминга
- нормализации форматирования (bold, списки, абзацы)
- очистки LaTeX и математических символов
- исправления склеенных слов
