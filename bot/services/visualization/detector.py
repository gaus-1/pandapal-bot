...
class VisualizationDetector:
    ...
    def detect(self, text: str) -> tuple[bytes, str] | None:
        """
        ...
        map_keywords = [
            r"карт[аеыу]?\s+(?:страны|мира|япони|росси|кита|сша|франци|германи|великобритани|инди|бразили|австрали|канад|итали|испани|египт|мексик)",
            r"покажи\s+(?:карт[аеыу]|где\s+находится|местоположени)",
            r"где\s+находится\s+(?:япони|росси|кита|сша|франци|германи|великобритани|инди|бразили|австрали|канад|итали|испани|египт|мексик|страна)",
            r"местоположени[ея]\s+(?:япони|росси|кита|сша|франци|германи|великобритани|инди|бразили|австрали|канад|итали|испани|египт|мексик)",
        ]
        ...
        for pattern in map_keywords:
            ...
            if match:
                ...
                country_match = re.search(
                    r"(япони|росси|кита|сша|франци|германи|великобритани|инди|бразили|австрали|канад|итали|испани|египт|мексик|страна)",
                    text_lower,
                )
                if country_match:
                    ...
                    if image:
                        ...
                        return image, f"карта {country_name}"
                else:
