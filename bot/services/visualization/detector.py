    ...
    def detect_geography_question(self, text: str) -> str | None:
        ...
        for pattern in geo_patterns:
            ...
            if match:
                ...
                known_locations = [
                    # Страны
                    "китай", "россия", "сша", "америка", "франция", "германия",
                    "италия", "испания", "япония", "корея", "индия", "бразилия",
                    "австралия", "канада", "мексика", "египет", "турция", "греция",
                    "польша", "украина", "англия", "великобритания", "нидерланды",
                    "бельгия", "швейцария", "австрия", "швеция", "норвегия",
                    "финляндия", "дания", "чехия", "венгрия", "румыния", "болгария",
                    "сербия", "хорватия", "португалия", "ирландия", "исландия",
                    "тайланд", "таиланд", "вьетнам", "индонезия", "филиппины",
                    "малайзия", "сингапур", "иран", "ирак", "израиль", "саудовская",
                    "оаэ", "эмираты", "катар", "пакистан", "афганистан", "казахстан",
                    "узбекистан", "монголия", "грузия", "армения", "азербайджан",
                    "аргентина", "чили", "перу", "колумбия", "венесуэла", "куба",
                    "юар", "нигерия", "кения", "эфиопия", "марокко", "алжир",
                    # Континенты
                    "европа", "азия", "африка", "америка", "австралия", "антарктида",
                    # Города
                    "москва", "петербург", "питер", "спб", "лондон", "париж",
                    "берлин", "рим", "мадрид", "токио", "пекин", "шанхай",
                    "нью-йорк", "лос-анджелес", "сидней", "дубай", "стамбул",
                ]
    ...
    def detect(self, text: str) -> tuple[bytes | None, str | None]:
            ...
            for pattern in map_keywords:
                ...
                if match:
                    ...
                    if okrug_match and "москв" in text_lower:
                        ...
                        okrug_map = {
                            "цао": "цао", "центральн": "центральный",
                            "сао": "сао", "северн": "северный",
                            "свао": "свао", "северо-восточн": "северо-восточный",
                            "вао": "вао", "восточн": "восточный",
                            "ювао": "ювао", "юго-восточн": "юго-восточный",
                            "юао": "юао", "южн": "южный",
                            "юзао": "юзао", "юго-западн": "юго-западный",
                            "зао": "зао", "западн": "западный",
                            "сзао": "сзао", "северо-западн": "северо-западный",
                        }
                    ...
                    if district_match:
                        ...
                        elif "москв" in text_lower or district_name in ["арбат", "тверской", "хамовники", "замоскворечье", "китай-город", "басманный", "таганский", "пресненский", "мещанский"]:
        ...
        for pattern in climatogram_patterns:
            if re.search(pattern, text_lower):
                ...
                zone = "тайга"
                for z in ["тайга", "степь", "пустыня", "тропики", "москва", "сочи", "арктика", "экватор"]:
                    if z in text_lower:
                        zone = z
                        break
