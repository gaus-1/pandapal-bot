...
class ContentModerationService:
    ...
    def is_safe_content(self, text: str) -> Tuple[bool, Optional[str]]:
        ...
        educational_contexts = [
            'история россии', 'история древнего мира', 'история средних веков',
            'расскажи про историю', 'объясни историю', 'помоги с историей',
            'география россии', 'география мира', 'физика', 'химия', 'биология',
            'математика', 'русский язык', 'литература', 'английский язык',
            'урок', 'домашнее задание', 'контрольная работа', 'экзамен',
            'школьная программа', 'учебник', 'учеба', 'обучение'
        ]
