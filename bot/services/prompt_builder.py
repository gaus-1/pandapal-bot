...
class PromptBuilder:
    ...
    def build_system_prompt(
        ...
        #
        # # 4. Использование имени (естественно, не навязчиво)
        ...
        #                 f"Если это уместно, естественно упомяни его имя в ответе."
        #             )
        ...
        # # Редирект на учебу (закомментировано - даем модели свободу)
        ...
        # #     )
        #
        # # Анализ ключевых слов (закомментировано - модель сама понимает контекст)
        # # important_words = []
        # # question_words = [
        # #     "как",
        # #     "что",
        ...
        # #     )
        #
        # # Структурные инструкции (закомментировано - даем модели полную свободу)
        # # prompt += self._get_strict_structure_instruction(user_message=user_message)

        # Полная свобода для Yandex Pro 5.1 - возвращаем пустую строку
        return ""
