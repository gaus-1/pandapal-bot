...
class PromptBuilder:
    ...
    def _get_greeting_context(
        ...
        # Определяем, поздоровался ли пользователь
        greeting_keywords = [
            "привет",
            "здравствуй",
            "здравствуйте",
        ...
        # ОСОБЫЙ СЛУЧАЙ (проверяем ПЕРЕД общим):
        # После очистки истории, если панда уже поздоровалась и пользователь тоже —
        ...
        # Общий случай: история очищена и приветствие было — НЕ здороваться снова
