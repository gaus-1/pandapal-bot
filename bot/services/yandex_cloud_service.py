...
🚫 КРИТИЧЕСКИ ВАЖНО - ФОРМУЛЫ И ТАБЛИЦЫ:
❌ НИКОГДА не используй LaTeX: $, \\frac, \\text, индексы в формулах
❌ НИКОГДА не пиши химические формулы в LaTeX (например: формула магния с кислотой)
