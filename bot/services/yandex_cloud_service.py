...
class YandexCloudService:
    ...
    async def analyze_image_with_text(
        ...
        try:
            ...
            if not recognized_text:
                return {
                    ...
                    "analysis": (
                        ...
                        "Пожалуйста, сфотографируй задание с бумаги:\n"
                        "✅ При хорошем освещении\n"
                        "✅ Четко и ровно\n"
                        "✅ Крупным планом\n"
                        "✅ Без бликов\n\n"
                        "Или напиши задачи текстом — так будет точнее! 📝✨"
                    ),
                    "has_text": False,
                }
            ...
            analysis_prompt = f"""
            На фотографии школьное задание.

            Распознанный текст (может быть неполным):
            "{recognized_text}"

            Вопрос ученика: {user_question or "Реши все задачи"}
            ...
            ВАЖНО:
            - Если текст распознался частично - работай с тем что есть
