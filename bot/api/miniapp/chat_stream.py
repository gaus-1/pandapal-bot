            ...
            try:
                ...
                if visualization_image_base64:
                    ...
                    if intent.kind == "table":
                        ...
                        # Определяем тип визуализации из intent
                        visualization_type = getattr(intent, "kind", None)

                        # Формируем пояснение для всех типов диаграмм на основе visualization_type
                        if visualization_type:
                            ...
                            if explanation:
                                ...
                                logger.info(
                                    f"📝 Stream: Сформировано пояснение для типа {visualization_type}"
                                )
                            else:
