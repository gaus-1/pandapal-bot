...
- Общее: умножение для младших — «×», для старших — «·» (2·a, a·x²). Деление: «:» или «/»; дроби (числитель)/(знаменатель). Степень — верхний индекс; корень √. Скобки для порядка действий. Примеры: S = a × b; s = v × t; квадратное уравнение a·x² + b·x + c = 0, D = b² - 4·a·c, x = (-b ± √D)/(2·a). Длинные формулы — по шагам.
