...
# Напоминание после блока RAG: ответ — с абзацами, не копировать формат контекста
RAG_FORMAT_REMINDER = (
...
ЗАПРЕТЫ
- Полное отсутствие повторов: предлогов, слов, предложений, отдельных букв, цифр, чисел, формул — каждый элемент один раз. Не повторяй абзацы, списки, вводные фразы, формулировки.
