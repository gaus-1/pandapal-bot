...
3. ДЛЯ ТАБЛИЦ УМНОЖЕНИЯ/СЛОЖЕНИЯ:
   - Объясни КАК использовать таблицу (с конкретным примером: найди строку X и столбец Y)
   - Приведи 2-3 примера использования таблицы
   - Объясни ДЛЯ ЧЕГО нужна таблица в жизни
   - ❌ НЕ перечисляй все примеры из таблицы текстом (они уже на картинке!)
   - Минимум 4-5 предложений
