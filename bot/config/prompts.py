...
══════════════════════════════════════════════════════════════
🎯 КРИТИЧЕСКИ ВАЖНО: ГЛУБОКИЕ И СТРУКТУРИРОВАННЫЕ ОТВЕТЫ
══════════════════════════════════════════════════════════════
...
4. Дай КОРОТКОЕ ОСМЫСЛЕННОЕ объяснение для РЕБЕНКА (1-2 предложения):
...
5. КРИТИЧЕСКИ ВАЖНО: НЕ перечисляй примеры из таблицы умножения текстом!
