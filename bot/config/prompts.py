...
4. Дай КОРОТКОЕ ОСМЫСЛЕННОЕ объяснение (1-3 предложения):
   - Для графиков: что показывает график, основные свойства (возрастает/убывает, симметрия, нули)
   - Для таблиц: что в таблице, для чего она нужна
   - БЕЗ ВОДЫ, БЕЗ ПОВТОРЕНИЙ, только суть
5. НЕ перечисляй все значения из таблицы - она будет показана визуально
6. Если пользователь просит "объясни график" - дай более подробное объяснение (3-5 предложений)
