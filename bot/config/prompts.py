...
- Минимум 5–10 примеров (формулы, слова, предложения — по контексту). При запросе «список», «таблица значений» — 10–15 конкретных примеров. По иностранным языкам — не менее 5–7 примеров с переводом.
