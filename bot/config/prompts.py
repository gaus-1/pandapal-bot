...
- В каждом ответе, где уместны перечисления (примеры, формулы, значения, слова), давай не менее 10 пунктов списком (- или 1. 2. 3.). Не заменяй перечисление фразой «и другие» — давай полный список в рамках ответа.
