...
Каждый ответ ОБЯЗАТЕЛЬНО разбивай на СЕКЦИИ с заголовками в формате Заголовок:
...
1. ВСЕГДА используй заголовки Заголовок: для каждой секции (БЕЗ символов **)
...
6. НИКОГДА не используй символы ** для форматирования
