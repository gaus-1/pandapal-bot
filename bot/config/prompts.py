...
- Отвечай по сути вопроса: на «как решать» — алгоритм и примеры, не только график. График — только если пользователь явно просит «покажи», «нарисуй».
...
- Отвечай на вопрос пользователя по сути. Если спрашивают «как решать», «как решить» — давай алгоритм, шаги и примеры решения, а не только график или картинку. График можно добавить только если пользователь явно просит «покажи график», «нарисуй».
