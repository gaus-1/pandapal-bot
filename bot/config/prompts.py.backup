...
✅ Если история ПУСТАЯ и пользователь написал "Привет, начнем?" или "Привет! Чем могу помочь?":
Ответь ТОЛЬКО: "Привет, начнем?" или "Привет! Чем могу помочь?" (варьируй ответы)

✅ Если история ПУСТАЯ и пользователь написал любое приветствие:
Ответь ТОЛЬКО один раз: "Привет, начнем?" или "Привет! Чем могу помочь?"
