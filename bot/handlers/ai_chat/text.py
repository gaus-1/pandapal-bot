            ...
            if visualization_image and visualization_type:
                ...
                if visualization_type == "multiplication_table":
                    enhanced_user_message = (
                        f"{user_message}\n\n"
                        f"[Дай ИСЧЕРПЫВАЮЩЕЕ глубокое пояснение про таблицу умножения: "
                        f"как её использовать (с конкретным примером), для чего она нужна, как читать таблицу. "
                        f"Разбери несколько примеров использования таблицы. "
                        f"НЕ перечисляй все значения из таблицы текстом - таблица уже показана! "
                        f"НЕ упоминай графики, параболы или другие темы. "
                        f"Отвечай ТОЛЬКО на вопрос пользователя про таблицу умножения. "
                        f"Минимум 4-5 предложений с примерами и пояснениями.]"
                    )
                elif visualization_type == "graph":
                    enhanced_user_message = (
                        f"{user_message}\n\n"
                        f"[Дай ИСЧЕРПЫВАЮЩЕЕ глубокое пояснение про этот график: "
                        f"что он показывает, как его читать (с конкретными примерами из графика), "
                        f"основные свойства (возрастает/убывает, симметрия, нули, максимумы/минимумы). "
                        f"Разбери несколько конкретных примеров из графика. "
                    ...
                    enhanced_user_message = (
                        f"{user_message}\n\n"
                        f"[Дай ИСЧЕРПЫВАЮЩЕЕ глубокое пояснение про карту: "
                        f"что показывает карта, где находится объект, основные географические особенности, "
                        f"соседние территории, водные объекты, важные достопримечательности. "
                        f"Разбери несколько конкретных примеров из карты. "
                    ...
                    enhanced_user_message = (
                        f"{user_message}\n\n"
                        f"[Дай ИСЧЕРПЫВАЮЩЕЕ глубокое пояснение ТОЛЬКО по теме запроса пользователя: "
                        f"разбери тему подробно с примерами, объясни как использовать визуализацию. "
