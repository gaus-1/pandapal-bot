...
def build_visualization_enhanced_message(
    ...
    if viz_type == "multiplication_table":
        return (
            ...
            "Не упоминай графики, параболы или другие темы. "
            "Отвечай только на вопрос про таблицу умножения. "
    ...
    if viz_type in _DIAGRAM_NAMES:
        ...
        return (
            ...
            f"основные особенности и закономерности. "
            f"Разбери несколько конкретных примеров из визуализации. "
            f"Не дублируй визуализацию текстом (не перечисляй все значения). "
            f"В конце ответа задай один вовлекающий вопрос "
            f"(например: «Понятно? Могу объяснить подробнее?»). "
    ...
    if viz_type == "map":
        return (
            ...
            "В конце ответа задай один вовлекающий вопрос. "
            "Минимум 5–6 предложений с примерами и пояснениями."
        )

    # Общий тип визуализации
    return (
        f"{user_message}\n\n"
