    ...
    with get_db() as db:
        ...
        keyboard.inline_keyboard.append([
            InlineKeyboardButton(
                ...
                callback_data="parent_link_child"
            )
        ])
        ...
        keyboard.inline_keyboard.append([
            InlineKeyboardButton(
                ...
                callback_data="parent_general_stats"
            )
        ])
...
"""
        ...
        keyboard = InlineKeyboardMarkup(inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="📊 Отчет за месяц",
                    callback_data=f"parent_monthly_report_{child_id}"
                ),
                InlineKeyboardButton(
                    text="⚙️ Настройки",
                    callback_data=f"parent_settings_{child_id}"
                )
            ],
            [
                InlineKeyboardButton(
                    text="🔙 Назад к списку",
                    callback_data="parent_control_back"
                )
            ]
        ])
...
"""
        ...
        keyboard = InlineKeyboardMarkup(inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="🔙 Назад",
                    callback_data=f"parent_view_child_{child_id}"
                )
            ]
        ])
