...
- Настройка типа пользователя (ребенок, родитель)
...
- waiting_for_user_type: Ожидание выбора типа пользователя
...
async def show_settings(message: Message):
    ...
    with get_db() as db:
        ...
        user_type_labels = {"child": "Ученик", "parent": "Родитель"}
        user_type_display = user_type_labels.get(user.user_type, user.user_type)
