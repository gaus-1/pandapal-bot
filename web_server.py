...
async def start_bot_background():
    ...
    try:
        ...
        # ОТКЛЮЧЕНО: Бот на Render вызывает конфликты из-за Polling
        # Используйте webhook или запускайте бота локально
        logger.info("ℹ️ Автозапуск бота отключен на Render")
        # await bot_main()
